    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(LoginActivity.this,FragmentMapActivity.class);
                    ...
                    .enqueue(new ApolloCall.Callback<LoginMutation.Data>() {
                        ...
                        public void onResponse(@Nonnull Response<LoginMutation.Data> response) {
                            ...
                            if (response.data()==null) {
                                ...
                                editor.putString("email", response.data().login().username());
                                ...
                                myIntent.putExtra("email", response.data().login().username());
